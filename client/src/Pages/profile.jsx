...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col gap-8 p-10 bg-gray-100">
      <div className="w-full h-[40vh] bg-white rounded-lg shadow-lg flex items-center px-10 gap-52">
        <div className="photo h-[70%] aspect-square rounded-full overflow-hidden border-4 border-gray-300">
          <img src="https://s.yimg.com/fz/api/res/1.2/XXKeauX0aPeO3eAunIuezA--~C/YXBwaWQ9c3JjaGRkO2ZpPWZpdDtoPTI2MDtxPTgwO3c9MTg2/https://s.yimg.com/zb/imgv1/448ece45-b5ed-36ed-be28-7af7af410480/t_500x300" alt="Profile" className='h-full w-full object-cover' />
        </div>
        <div className="flex h-[25vh] flex-col justify-between">
          <h2 className='text-2xl text-neutral-700'>Hello <span className='text-6xl capitalize text-black'>Ishant Mishra</span>, what a great day to learn sign language!</h2>
          <div className="btn flex gap-4">
            <button className="px-8 py-3 border-2 border-black duration-200 cursor-pointer  hover:bg-red-500 hover:text-white" onClick={logout}>Logout</button>
            <button className="px-8 py-3 bg-sec cursor-pointer border-2 border-black">Edit Profile</button>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full gap-6 overflow-x-hidden justify-center">
        ...
        <div className="h-[40vh] shadow-lg rounded-md w-[30vw] p-5 bg-white flex flex-col gap-7">
          ...
          <button className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600">Donate Now</button>
        </div>
      </div>
    </div>
  );
